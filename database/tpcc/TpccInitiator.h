...
class TpccInitiator : public BenchmarkInitiator {
   ...
   protected:
    virtual void RegisterTables(const GAddr& storage_addr,
        ...
        // 将table_count和每个table的schema以及index(hash index: bucket count,
        // root addr等)写入gam中
   ...
   public:
    static void InitItemSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("i_name", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("i_price", ValueType::DOUBLE));
        columns.push_back(new ColumnInfo("i_data", ValueType::VARCHAR,
    ...
    static void InitWarehouseSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("w_name", ValueType::VARCHAR,
                                         static_cast<size_t>(16)));
        columns.push_back(new ColumnInfo("w_street_1", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("w_street_2", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("w_city", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("w_state", ValueType::VARCHAR,
                                         static_cast<size_t>(2)));
        columns.push_back(new ColumnInfo("w_zip", ValueType::VARCHAR,
    ...
    static void InitDistrictSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("d_name", ValueType::VARCHAR,
                                         static_cast<size_t>(16)));
        columns.push_back(new ColumnInfo("d_street_1", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("d_street_2", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("d_city", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("d_state", ValueType::VARCHAR,
                                         static_cast<size_t>(2)));
        columns.push_back(new ColumnInfo("d_zip", ValueType::VARCHAR,
                                         static_cast<size_t>(9)));
    ...
    static void InitCustomerSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("c_first", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_middle", ValueType::VARCHAR,
                                         static_cast<size_t>(2)));
        columns.push_back(new ColumnInfo("c_last", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_street_1", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_street_2", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_city", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_state", ValueType::VARCHAR,
                                         static_cast<size_t>(2)));
        columns.push_back(new ColumnInfo("c_zip", ValueType::VARCHAR,
                                         static_cast<size_t>(9)));
        columns.push_back(new ColumnInfo("c_phone", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("c_since", ValueType::INT64));
        columns.push_back(new ColumnInfo("c_credit", ValueType::VARCHAR,
                                         static_cast<size_t>(2)));
    ...
    static void InitOrderLineSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("ol_dist_info", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("meta", ValueType::META));
    ...
    static void InitHistorySchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        columns.push_back(new ColumnInfo("h_data", ValueType::VARCHAR,
                                         static_cast<size_t>(32)));
        columns.push_back(new ColumnInfo("meta", ValueType::META));
    ...
    static void InitStockSchema(RecordSchema*& schema, GAlloc* gallocator) {
        ...
        for (size_t i = 0; i < 10; ++i) {
            ...
            columns.push_back(new ColumnInfo(name.c_str(), ValueType::VARCHAR,
                                             static_cast<size_t>(32)));
        }
        ...
        columns.push_back(new ColumnInfo("s_data", ValueType::VARCHAR,
                                         static_cast<size_t>(64)));
        columns.push_back(new ColumnInfo("meta", ValueType::META));
