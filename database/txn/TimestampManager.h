...
namespace Database {
  ...
  {
  public:
    TimestampManager(GAddr epoch_addr, GAddr monotone_ts_addr, bool is_master, GAlloc* epoch_gallocator) : 
      epoch_(epoch_addr, is_master, epoch_gallocator), g_timestamp_(monotone_ts_addr) {
