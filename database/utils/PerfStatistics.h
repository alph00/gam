...
struct PerfStatistics {
    ...
    void PrintAgg() {
        std::cout << "==================== perf statistics summary "
                     "===================="
                  << std::endl;
        double abort_rate =
            agg_total_abort_count_ * 1.0 / (agg_total_count_ + 1);
        printf(
        ...
        /*std::cout << "agg_total_count=" << agg_total_count_ <<",
         ...
         agg_elapsed_time_ * 1.0 / agg_node_num_ << "ms." << std::endl;
         std::cout << "total throughput=" << agg_throughput_ << "K tps,per node
         throughput="
         << agg_throughput_ / agg_node_num_ << "K tps." << ",per core
         throughput=" << agg_throughput_ / agg_thread_count_ << std::endl;*/
        std::cout << "==================== end ===================="
                  << std::endl;
    }
    void Print() {
