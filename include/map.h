...
template <typename key_type, typename mapped_type,
          size_t BUCKET_SIZE_POWER = DEFAULT_BUCKET_SIZE_POWER,
#ifdef USE_CITYHASH
          ...
          class Alloc = std::allocator<std::pair<const key_type, mapped_type>>>
class Map {
   ...
   public:
    ...
    void unlock_hv(size_t hv) { buckets_[hv]->unlock(); }
