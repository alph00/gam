...
#define MASTER_RDMA_SRQ_RX_DEPTH (MAX_MASTER_PENDING_MSG * MAX_NUM_WORKER)
...
#define MAX_WORKERS_STRLEN                                 \
    (MAX_NUM_WORKER * MAX_IPPORT_STRLEN + MAX_NUM_WORKER - \
     1)  // 192.168.154.154:12345,
