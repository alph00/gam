...
struct WorkRequest {
    ...
    unsigned int pid;  // identifier of the parent work request (used for
                       // FORWARD request)
    ...
    bool IsACopy() { return (flag & COPY) && (dup == nullptr); }
    ...
    void Reset() {
        ...
        pid = 0;  // identifier of the parent work request (used for FORWARD
                  // request)
