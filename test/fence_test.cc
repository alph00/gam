    ...
    for (int i = 0; i < iteration; i++) {
...

        {
            ...
            if (buf == wbuf) {
                ...
                epicLog(LOG_WARNING, "remote read g2 failed expect %d, but %d",
                        wbuf, buf);
                exit(1);
            }
        }
...

        {
            ...
            if (buf == wbuf) {
                ...
                epicLog(LOG_WARNING, "remote read g3 failed expect %d, but %d",
                        wbuf, buf);
                exit(1);
            }
        }

        {
            ...
            if (buf == wbuf) {
                ...
                epicLog(LOG_WARNING, "local read failed expect %d, but %d",
                        wbuf, buf);
                exit(1);
            }
        }

        {
            ...
            if (buf == wbuf) {
                ...
                epicLog(LOG_WARNING, "remote read failed expect %d, but %d",
                        wbuf, buf);
                exit(1);
            }
        }
...
void thread2() {
    ...
    for (int i = 0; i < iteration; i++) {
        ...
        epicAssert((rg2 >= rg1 && rg1 >= rg3) || rg1 == wbuf || rg2 == wbuf ||
                   rg3 == wbuf);
    }
